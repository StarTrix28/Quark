package me.startrix.quark.libraries.abstracts;
...
public abstract class NoPowerAContainer extends SlimefunItem implements InventoryBlock, MachineProcessHolder<CraftingOperation> {
    ...
    protected NoPowerAContainer(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected BlockBreakHandler onBlockBreak() {
        return new SimpleBlockBreakHandler() {
            public void onBlockBreak(Block b) {
                ...
                if (inv != null) {
                    inv.dropItems(b.getLocation(), NoPowerAContainer.this.getInputSlots());
                    inv.dropItems(b.getLocation(), NoPowerAContainer.this.getOutputSlots());
                }

                NoPowerAContainer.this.processor.endOperation(b);
            }
        };
    }

    @ParametersAreNonnullByDefault
    protected NoPowerAContainer(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
    ...
    public final NoPowerAContainer setProcessingSpeed(int speed) {
