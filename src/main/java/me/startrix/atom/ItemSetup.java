...
public class ItemSetup {
    ...
    private void registerAdvancedElectricity() {
        ...
        (new ElectricDustWasher(CategoryAdvancedElectricity, SlimefunItems.ELECTRIC_DUST_WASHER,new RecipeType(new CustomItemStack(Material.BARRIER,"Not yet implemented"),"notimplemented"), new ItemStack[]{})).setCapacity(128).setEnergyConsumption(32).setProcessingSpeed(15).register(plugin);
        (new ElectricDustWasher(CategoryAdvancedElectricity, SlimefunItems.ELECTRIC_DUST_WASHER,new RecipeType(new CustomItemStack(Material.BARRIER,"Not yet implemented"),"notimplemented"), new ItemStack[]{})).setCapacity(128).setEnergyConsumption(48).setProcessingSpeed(20).register(plugin);
        (new ElectricDustWasher(CategoryAdvancedElectricity, SlimefunItems.ELECTRIC_DUST_WASHER,new RecipeType(new CustomItemStack(Material.BARRIER,"Not yet implemented"),"notimplemented"), new ItemStack[]{})).setCapacity(128).setEnergyConsumption(64).setProcessingSpeed(50).register(plugin);
